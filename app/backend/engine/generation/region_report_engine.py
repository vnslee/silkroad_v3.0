    ...
    def compute_quickwin(self, killswitch: Dict, attractiveness: Dict,
        ...
        return {
            ...
            "ranking": [{"rank": r["rank"], "country": r["country"],
                        ...
                        for r in ranked],
            "note": {
                "ko": "퀵윈 = 매력도×비즈니스 가중치 + IT유사도×IT 가중치. 기준국(B국)·진출국(운영중)·JV필수국(킬스위치) 제외. JV권고국은 감점 후 포함. 10점 구간 표기.",
                "en": "Quickwin = Attractiveness×Business weight + IT×IT weight. Baseline, already-entered, and JV-required (killswitch) countries excluded. JV-recommended countries included with a penalty. Reported in 10-point buckets.",
            },
        }
